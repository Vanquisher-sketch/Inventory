    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary">Formulir Tambah Data Peralatan (KIB B)</h6>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ukuran_cc" class="form-control" value="{{ old('ukuran_cc') }}">
                        </div>
                        <div class="form-group">
                            <label>Bahan</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="tahun_pembelian" class="form-control" placeholder="YYYY" value="{{ old('tahun_pembelian') }}" required>
                        </div>
                    </div>
                    <!-- Kolom Kanan -->
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nomor_pabrik" class="form-control" value="{{ old('nomor_pabrik') }}">
                        </div>
                        <div class="form-group">
