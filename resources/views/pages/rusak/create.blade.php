            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="m-0 font-weight-bold text-primary">Formulir Tambah Data Barang Rusak</h6>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('rusak.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_id_pemda" class="form-control" value="{{ old('no_id_pemda') }}" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="tahun_perolehan" class="form-control" placeholder="YYYY" value="{{ old('tahun_perolehan') }}" required>
                        </div>
                        <div class="form-group">
                            <label>Harga Perolehan (Rp) <span class="text-danger">*</span></label>
                            <input type="number" name="harga_perolehan" class="form-control" value="{{ old('harga_perolehan') }}" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="tercatat_di_kib" class="form-control" required>
                                ...
                                <option value="KIB-A" {{ old('tercatat_di_kib') == 'KIB-A' ? 'selected' : '' }}>KIB A - Tanah</option>
                                <option value="KIB-B" {{ old('tercatat_di_kib') == 'KIB-B' ? 'selected' : '' }}>KIB B - Peralatan & Mesin</option>
                                <option value="KIB-C" {{ old('tercatat_di_kib') == 'KIB-C' ? 'selected' : '' }}>KIB C - Gedung & Bangunan</option>
                                <option value="KIB-D" {{ old('tercatat_di_kib') == 'KIB-D' ? 'selected' : '' }}>KIB D - Jalan, Irigasi & Jaringan</option>
                            </select>
                        </div>
                        <div class="form-group">
