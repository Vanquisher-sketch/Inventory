...
@section('tittle, Ruangan Kecamatan')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <a href="{{ route('room.edit', $room->id) }}" class="d-inline-block mr-2 btn btn-sm btn-warning">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            
                                            {{-- PERBAIKAN: Form untuk hapus juga disesuaikan route-nya --}}
                                            <form action="{{ route('room.destroy', $room->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus ruangan ini?');">
                                                @csrf
                                                @method('DELETE')
